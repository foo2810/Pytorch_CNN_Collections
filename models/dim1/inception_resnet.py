...
class InceptionResNetV2Base(nn.Module):
    def __init__(self, in_channels, stage_a, stage_b, stage_c):
        ...
        self.head_path = nn.Sequential(
            ...
            nn.MaxPool1d(kernel_size=3, stride=2, padding=3//2),
        ...
        # Branches 2
        self.b2_conv11 = ConvBNReLU(320, 384, kernel_size=3, stride=1, padding=3//2)
        ...
        self.b2_conv23 = ConvBNReLU(256, 384, kernel_size=3, stride=1, padding=3//2)
...
class InceptionModule17(nn.Module):
    def __init__(self, in_channels, scale=1.0, activation_fn=nn.ReLU):
        ...
        self.conv22 = ConvBNReLU(128, 160, kernel_size=7, stride=1, padding=7//2)
        self.conv23 = ConvBNReLU(160, 192, kernel_size=7, stride=1, padding=7//2)
...
class InceptionModule8(nn.Module):
    def __init__(self, in_channels, scale=1.0, activation_fn=nn.ReLU):
        ...
        self.conv22 = ConvBNReLU(192, 224, kernel_size=3, stride=1, padding=3//2)
        self.conv23 = ConvBNReLU(224, 256, kernel_size=3, stride=1, padding=3//2)
